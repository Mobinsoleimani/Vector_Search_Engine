...
file = 'vector_search_engine/cpp_engine/vector.bin'
...
if not os.path.isfile(file):
    ...
    with open(file, "r+b") as f:
        ...
        f.write(embedding.tobytes())
with open("vector_search_engine/cpp_engine/vector.txt", mode='a', encoding="utf-8") as vector:
    vector.write(data + "\n")

with open("vector_search_engine/cpp_engine/query.bin",mode = 'wb') as query:
